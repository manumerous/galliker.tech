...
- **Data Processing:** Responsible to load and preprocess the data used to estimate the dynamics model. It contains functionalities to filter, re-sample and normalize the data.
